...
const HeroSection = () => (
  <section className="mt-10 max-w-3xl mx-auto">
    <div className="p-5 md:p-10 flex flex-col md:flex-row mb-4 border-2 xs:border-1 sm:border-4 border-emerald-800 bg-emerald-800 bg-opacity-20 rounded-2xl shadow-[5px_5px_20px_rgba(0,0,0,0.7)]">
